...
void part1() {
    ...
    std::string word;   
    int num{0};
    std::ifstream in_file {"/Users/mattwalsh/Documents/Projects/out-of-tree-builds/projects/Challenges/Challenge_3/words.txt"};
    if (in_file) {
        ...
        while(std::getline(in_file, line)) {
            ...
            while(ss>>word) {
                ...
                if(it != words.end()) {
                    ...
                    words.insert(std::pair<std::string, std::set<int>>(word, {lineNo}));
                }
            }
